...
var uidname = 'ssouid';
var ARROW = (function () {
    function ARROW(meta, allServers) {
        this.type = 'url_region_uid';
        this.index = 0;
        this.allServers = allServers;
        this.meta = meta;
    }
    ARROW.prototype.doit = function () {
    ...
    ARROW.prototype.location = function () {
    ...
    ARROW.prototype.uidsregionsHandler = function () {
        var r = "";
        for (var _i = 0, _a = this.meta.servers; _i < _a.length; _i++) {
            var v = _a[_i];
            if (v.uids) {
    ...
    ARROW.prototype.getOneUpstreamName = function (v) {
        if (v.uids) {
    ...
    ARROW.prototype.getUpstreamName = function () {
    ...
    ARROW.prototype.getUpstreams = function () {
        var s = "";
        for (var _i = 0, _a = this.meta.servers; _i < _a.length; _i++) {
            var v = _a[_i];
            var rr = '';
    ...
    ARROW.prototype.getDefault = function () {
        var n = this.getUpstreamName();
        var s = '';
        var arrd = [];
        for (var _i = 0, _a = this.meta.servers; _i < _a.length; _i++) {
